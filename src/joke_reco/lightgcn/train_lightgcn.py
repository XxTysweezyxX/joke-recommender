...
"""
Trains the original LightGCN recommender.
Builds the graph, samples BPR triplets, trains the model, and returns the training outputs.
"""
...
# Filters positives, builds the graph, and trains the model.
# ---------------------------------------------------------
def train_lightgcn(
    ...
    # ---------------------------------------------------------
    # 5.1 Positive interaction filtering
    # Keeps only ratings that count as positive interactions.
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # 5.2 Graph and index preparation
    # Builds ID maps and the normalised user-item graph.
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # 5.3 Positive lookup preparation
    # Builds the per-user positive item lookup used for BPR sampling.
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # 5.4 Model setup
    # Creates the model, graph tensor, optimiser, and RNG.
    # ---------------------------------------------------------
