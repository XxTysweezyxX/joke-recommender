...
- Compare actual Jester ratings with text-augmented LightGCN preference scores
- Build a clean table for dissertation analysis

Run from /src with:
    python -m scripts.analysis.ta_user_case_study_lightgcn
"""
...
def score_user_joke_pair(
    ...
    """
    Returns the text-augmented LightGCN preference score for one user-joke pair.
